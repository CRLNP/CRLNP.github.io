...
En utilisant la fonction names(mod) et en sélectionnant individuellement le nom de l'élément avec l'opérateur $:
...
```
 *À noter: par défaut les résultats sont présentés selon la notation scientifique. Pour la désactiver utiliser l'instruction: options(scipen = 999)*
