...
- *Numeric*, *real* ou *double*, *integer* (entier), *complex*, *raw* : différents formats numériques.
...
![](C:/Users/p0373489/Desktop/AtelierR/markdown/tobjet2.jpg)
...
*D'autres fonctions comme `merge()`, `cbind()` et `rbind()` permettent de fusionner des colonnes et lignes dans un tableau de données.*
