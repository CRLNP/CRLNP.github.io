...
```{r, echo=FALSE}
knitr::include_graphics("markdown/objet.jpg")
```  
...
```{r, echo=FALSE}
knitr::include_graphics("markdown/assignation.jpg")
```  
...
```{r, echo=FALSE}
knitr::include_graphics("markdown/boite3.png")
```  
...
knitr::include_graphics("markdown/fonction.jpg")
```  
...
```{r, echo=FALSE}
knitr::include_graphics("markdown/types.jpg")
```
